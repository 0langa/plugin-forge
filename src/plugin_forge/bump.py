...
Handles: `forge.yaml`, `pyproject.toml`, all provider manifests, README badge
lines, and marketplace manifests. Idempotent — running `bump` twice at the
same target version is a no-op.
"""
